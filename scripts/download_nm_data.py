...
def download_weather_data(fields_gdf):
    ...
    try:
        ...
        sys.path.insert(0, str(Path(__file__).parent.parent / "skills" / "vendor" / "ag-skills" / "nasa-power-weather" / "src"))
        ...
        print("You can retry this step later with: python scripts/download_nm_data.py --weather-only")
        return None
...
def download_cdl_data(fields_gdf):
    ...
    try:
        ...
        sys.path.insert(0, str(Path(__file__).parent.parent / "skills" / "vendor" / "ag-skills" / "cdl-cropland" / "src"))
