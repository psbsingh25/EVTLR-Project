...
def create_map_all_crops():
    ...
    for idx, row in gdf.iterrows():
        ...
        # Style function
        style = {"fillColor": color, "color": "black", "weight": 1, "fillOpacity": 0.7}
...
def main():
    ...
    print("  1. my_fields_map.html - All fields colored by crop type")
    print("  2. my_fields_corn_map.html - Corn fields only (5 fields)")
